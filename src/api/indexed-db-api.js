class IndexedDBApi {
     ...
     * @param {string} dbSchema.name
     * @param {number} dbSchema.version
     * @param {array} dbSchema.schema
    */
     ...
     */
    connect() {
        const dbSchema = this._getDbSchema();

        return this.connectDB(dbSchema.schema);
    }
